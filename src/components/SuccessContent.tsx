  ...
  if (!font || !fontUrl) {
    return (
      <div className="mx-auto max-w-4xl px-4 py-24 text-center">
        ...
        <Link
          href="/"
          className="mt-4 text-sm text-zinc-500 hover:text-zinc-800 dark:text-zinc-400 dark:hover:text-zinc-200"
        >
      ...
      {status === "error" && (
        <>
          ...
          <Link
            ...
            className="mt-6 inline-flex items-center gap-2 rounded-xl bg-zinc-900 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200"
          >
