...
export default function DownloadHistoryModal({ open, onClose }: DownloadHistoryModalProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="w-full max-w-lg max-h-[80vh] flex flex-col rounded-2xl bg-white shadow-xl dark:bg-zinc-900">
        ...
        <div className="flex-1 overflow-y-auto p-5">
          {loading ? (
            ...
            <div className="py-16 text-center">
              <svg className="mx-auto h-12 w-12 text-zinc-300 dark:text-zinc-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                return (
                  <li key={item.fontId}>
                    ...
                    >
                      <div className="relative h-12 w-12 shrink-0 overflow-hidden rounded-lg bg-zinc-100 dark:bg-zinc-800">
                        {cover ? (
                          ...
                          <div className="flex h-full items-center justify-center">
                            <span className="text-lg text-zinc-300 dark:text-zinc-600">
                              {item.name.charAt(0)}
                            </span>
                          </div>
                        )}
                      ...
                      <svg className="h-4 w-4 shrink-0 text-zinc-300 dark:text-zinc-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
