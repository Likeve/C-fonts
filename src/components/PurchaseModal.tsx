      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
        ...
        <div className="space-y-3">
          <button
            ...
            className="flex w-full items-center justify-between rounded-xl border-2 border-zinc-200 bg-white p-4 text-left transition-all hover:border-zinc-400"
          >
            <div>
          ...
          <button
            ...
            className="flex w-full items-center justify-between rounded-xl border-2 border-[#FEE3C7] bg-[#FEE3C7] p-4 text-left transition-all hover:bg-[#f5d0a8] hover:border-[#f5d0a8]"
          >
            <div>
